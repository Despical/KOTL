...
public class ConfigPreferences {
	...
	public enum Option {
		...
		DEBUG_MESSAGES(false), DISABLE_FALL_DAMAGE, DISABLE_SEPARATE_CHAT(false), FIREWORKS_ON_NEW_KING,
		INVENTORY_MANAGER_ENABLED, JOIN_NOTIFY, LEAVE_NOTIFY, REWARDS_ENABLED(false), SCOREBOARD_ENABLED,
		SEND_SETUP_TIPS, UPDATE_NOTIFIER_ENABLED(false);
