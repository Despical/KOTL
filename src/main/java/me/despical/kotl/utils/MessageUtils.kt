...
class MessageUtils private constructor() {
	...
	companion object {
		...
		fun updateIsHere() {
			...
			Bukkit.getConsoleSender().sendMessage("${ChatColor.RED} | | | |  _ __     __| |   __ _  | |_    ___ ")
			Bukkit.getConsoleSender().sendMessage("${ChatColor.RED} | | | | | '_ \\   / _` |  / _` | | __|  / _ \\")
			Bukkit.getConsoleSender().sendMessage("${ChatColor.RED} | |_| | | |_) | | (_| | | (_| | | |_  |  __/")
			Bukkit.getConsoleSender().sendMessage("${ChatColor.RED}  \\___/  | .__/   \\__,_|  \\__,_|  \\__|  \\___|")
			Bukkit.getConsoleSender().sendMessage("${ChatColor.RED}         |_|                                 ")
		}
	}
}